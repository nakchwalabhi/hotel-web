...
const Home = () => {
    ...
    },
    {
        ...
        description:'We love life at the beach. Being close to the ocean with access to endless sandy beach ensures a relaxed state of mind.',
        img:'/home-beach.png' 
    }]
    const section1 = homeData.map((elem, idx)=>{
        return (
            ...
            <div className='flex flex-col gap-3 h-fit px-10 border-l-2 mt-8'>
                <h1 className='font-bold text-4xl tracking-wide font-[Times_New_Roman] text-[rgb(19,38,74)]'>{elem.title}</h1>
